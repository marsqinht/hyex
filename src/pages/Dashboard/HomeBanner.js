    ...
    this.imgArray = [
      {
        ...
        content: <div> 
          <p>
            <b style={{color: bcolor}}>战略定位：</b>&nbsp;化工领域的工程设计和项目管理服务商。
          </p>
          <p>
            <b style={{color: bcolor}}>功能定位：</b>一. 承担集团产业的工程化，包括推进集团工程管理的标准化、集团的技术资源协同集成。二. 工程设计业务市场化运作，业内外结合。
          </p>
          <p />
          <p>

            <b style={{color: bcolor}}>发展规划原则:</b>
            <div>
              <div><b style={{color: bcolor}}>工程服务特色化：</b>业务范围涵盖能源化工、氯碱化工、精细化工和环境保护四大业务板块，成为项目前期、技术许可、项目实施、开车服务和工厂运营等全过程的工程服务商；</div>
              <div><b style={{color: bcolor}}>技术工程产业化：</b>依托集团公司和外部技术开发资源，持续加大产业化开发投入，关注行业同类技术开发进展和竞争态势，形成独有或领先的产业化核心技术；</div>
              <div><b style={{color: bcolor}}>环保工程运营化：</b>借助合作方在运营方面的成功经验和品牌优势，在环保工程总承包的基础上，拓展环保工程运营服务并逐步建立竞争优势；</div>
              <div><b style={{color: bcolor}}>海外工程合作化：</b>坚持以“借船出海”的方式寻求突破点，逐步建立与具有海外成功经验的大型实体公司和国内外大型工程公司的长期合作关系，同时依托集团公司的海外投资，以公司擅长业务领域为起点逐步开拓、培育海外市场。</div>
            </div>
          </p>
          <p>
      ...
      },
      {
        ...
        content: <div>
          ...
          <p>
            <b style={{color: bcolor}}>协力:</b>&nbsp;齐众力，则无敌；集众智，则无畏。公司上下同心协力，方能共赢。<br />
        协力是工程公司的行业特征和岗位职业要求，也是一种组织能力和价值取向。公司全体员工必须具有团队合作的强烈意识，才能保证项目实施和公司运行的渐进有序。
          </p>
          <p>
            <b style={{color: bcolor}}>创新:</b>&nbsp;公司追求服务创新、技术创新、管理创新；创新，是公司发展的原动力。<br />
      ...
      },
      {
        ...
        content: <div>
          ...
          <p>
            <b style={{color: bcolor}}>人材：</b>&nbsp;具备岗位任职资格和基本素质，有成才意愿和潜质，需公司进行系统培养。<br />
                                   具备人才的基本品质和渴望成长的意愿，能够快速融入工作环境，勤奋学习，踏实做事，灵活应变，成长为工作中高效的执行者，企业文化的践行者。
          </p>
          <p>
            <b style={{color: bcolor}}>人才：</b>&nbsp;具备岗位胜任力，能够快速融入工作、表现出色，为公司发展注入激情与活力。<br />
      ...
      },
      {
        img: 'https://tva1.sinaimg.cn/large/006y8mN6ly1g8ph55ngx0j318g0la7dn.jpg',
        title: '司训',
        content: <div>公司面对转型发展的挑战和机遇，唯有秉持“诚信、进取、感恩”之心，方能破茧成蝶。
          <p>
            <b style={{color: bcolor}}>诚信：</b>&nbsp;以诚感人者，人亦诚而应。<br />
           百德诚为先，百事信为本。诚信是企业立身之道，它是一种无形资产，反映了企业的商业伦理和价值信仰。诚信是员工为人之道，公司选人以诚、教人以信。构建完善的守信用、讲信誉、重信义的商业环境和企业文化对企业健康发展具有深远意义。
          </p>
          <p>
            <b style={{color: bcolor}}>进取：</b>&nbsp;求知进取、追求卓越是公司发展壮大的内在驱动力。<br />
